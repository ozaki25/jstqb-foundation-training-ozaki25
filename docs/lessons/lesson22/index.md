...
- テスト計画書はチーム内部の資料にとどまらず、ステークホルダーへの伝達手段でもある点が問われやすい
...
- 開始基準と終了基準やメトリクスは独立した項目ではなく、テスト計画書の「テストアプローチ」の項目に含まれる
- リリース計画（プロダクトのリリースを見据え、プロダクトバックログを定義・再定義）とイテレーション計画（1回のイテレーションの終わりを見据え、イテレーションバックログを考慮）を対で押さえ、入れ替えた選択肢に注意する
- すべてのイテレーションにおけるテストアプローチとテスト計画書のベースになるのは、イテレーション計画ではなくリリース計画
