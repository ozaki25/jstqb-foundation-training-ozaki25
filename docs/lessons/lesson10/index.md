...
- 本番稼働中のシステムに対する変更のテストは「変更の実装の成功の評価」と「変更していない部分のリグレッションのチェック」の両方を含む
- 変更していない部分は通常システムの大部分を占めるため、確認テストとリグレッションテストが中心になる
...
- 変更をする前に、他の領域への潜在的な影響に基づいて変更の採否を判断する影響度分析をすることがある
