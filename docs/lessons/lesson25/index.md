...
これらの行動は、リスクレベルに応じたテスト労力の配分として整理できます。リスクの高い箇所ほど、強いカバレッジ基準の技法で徹底的にテストし、重要な欠陥を早く見つけられるように優先順位を上げ、経験のある担当者を割り当てます。
