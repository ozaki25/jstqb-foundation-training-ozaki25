...
// CLAUDE.md 等の執筆方針のうち、機械で拾える再発しやすいものを対象にする:
//   1) 学ぶこと / 試験のポイント の項目が複文（「。」で 2 文に割れている）
...
// 使い方: node .claude/hooks/check-style.js docs/lessons/lesson07/index.md [...]
//         省略時は docs/lessons 配下の全 index.md を対象にする。
...
function scan(file) {
  ...
  lines.forEach((line, i) => {
    ...
    if ((section.includes("試験のポイント") || section.includes("学ぶこと")) && t.startsWith("- ")) {
